        ...
        fetch(titles_url)
            ...
            .then(() => {
                ...
                ChapterList.forEach(chapter => {
                    ...
                    chSearchresult.push(`<div class="chapter_item" id="${chapterID}"><a href="./chapter-${chapter.index + 1}"><p>${chapter.title}</p></a></div>`);
                    chapterID = "";
                });
...
function findChapter() {
    ...
    for (let i = 0; i < ChapterList.length; i++) {
        ...
        if (chSearchindex !== -1) {
            chSearchresult.push(`<div class="chapter_item"><a href="./chapter-${index + 1}"><p>${displayTitle}</p></a></div>`);
        }
